...
const OfferCard = ({ color, amount, tenure, interestRate, emi }) => {
  console.log("data", color, amount, tenure, interestRate, emi);

  return (
    <div
      className="w-[300px] overflow-hidden rounded-[20px] border bg-white shadow-md"
      style={{
        borderColor: color,
        boxShadow:
          "rgba(92, 92, 92, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8)",
      }}
    >
      ...
      <div className="p-6 text-center">
        ...
        >
          ...
          <div className="h-6 border-l" style={{ borderColor: color }}></div>
          <div className="space-y-[2px]">
