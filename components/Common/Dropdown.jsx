...
const Dropdown = ({ options, selected, onChange, error, placeholder }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ...
        className={`mt-2 flex h-[47.47px] w-full cursor-pointer items-center rounded-[12px] border border-[#DCDBDD] bg-white px-3 ${
